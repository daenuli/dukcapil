...
function origincode_contact_print_html_nav($count_items, $page_number, $serch_fields = "" ) {
	if ( $count_items ) {
		if ( $count_items % 20 ) {
	...
	<div class="tablenav top" style="width:100%">
		...
		<div class="tablenav-pages">
			...
			<span class="pagination-links">
				<a class="<?php echo $first_page; ?>" title="Go to the first page" href="javascript:origincode_contact_submit_href(<?php echo $page_number; ?>,-2);">«</a>
				<a class="<?php echo $prev_page; ?>" title="Go to the previous page" href="javascript:origincode_contact_submit_href(<?php echo $page_number; ?>,-1);">‹</a>
				...
				<a class="<?php echo $next_page ?>" title="Go to the next page" href="javascript:origincode_contact_submit_href(<?php echo $page_number; ?>,1);">›</a>
				<a class="<?php echo $last_page ?>" title="Go to the last page" href="javascript:origincode_contact_submit_href(<?php echo $page_number; ?>,2);">»</a>
			<?php endif; ?>
			</span>
		</div>
	</div>
