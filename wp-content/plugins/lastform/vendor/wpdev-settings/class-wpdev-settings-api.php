    ...
    class WPDEV_Settings_API_Form {
        ...
        protected function single_section( $section_id, $section ){
            ...
            if($disabled){
                ...
                $disabled_bg_color = isset( $section['disabled_bg_color'] ) ? $section['disabled_bg_color'] : '#8bc34a';
        ...
        protected function single_panel( $panel_id, $panel ){
            ...
            if($disabled){
                ...
                $disabled_bg_color = isset( $panel['disabled_bg_color'] ) ? $panel['disabled_bg_color'] : '#8bc34a';
